...
> **Target:** 500MW Solar PV Portfolio · sector `renewables` · Spain · ~€450M

The five agents run in sequence: News Ingestion → Signal Extraction → Buyer
Profiling → Deal Matching (deterministic scoring) → Strategy — and the final
deliverable is a tiered outreach plan with a deal-close-probability call.
